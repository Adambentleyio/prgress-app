export default function Testimonial( {name, quote, img, title, company}) {
    return (
        ...
        <div className="relative mx-auto max-w-7xl px-4 pt-20 pb-12 sm:px-6 lg:px-8 lg:py-20">
          ...
          <div className="relative lg:flex lg:items-center">
            <div className="hidden lg:block lg:flex-shrink-0">
              <img
                className="h-64 w-64 rounded-full xl:h-80 xl:w-80 object-cover object-top"
                src={img}
                alt=""
              />
            </div>
                ...
                <footer className="mt-8">
                  <div className="flex">
                    ...
                    <div className="ml-4 lg:ml-0">
                      ...
                      <div className="text-base font-medium text-indigo-600">{`${title}, ${company}`}</div>
                    </div>
                  </div>
                </footer>
              </blockquote>
